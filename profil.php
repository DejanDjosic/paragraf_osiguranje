...
<head>
    ...
    <title>Profil osiguranika</title>
</head>

<body>
    <?php include('delovi_stranica/navbar.php'); ?>
    <div class='jumbotron text-center'>
        <h2>Profil osiguranika</h2>
    </div>
    <table class="table">
        ...
        <tbody>
            <?php
            $broj_pasosa = $_SESSION['broj_pasosa'];
            $email = $_SESSION['email'];
            $datum_rodjenja = $_SESSION['datum_rodjenja'];
            $upit = "SELECT * FROM polisa WHERE datum_rodjenja='$datum_rodjenja' and email='$email'";
